...
public class Menu {
    private static ArrayList<FoodDrink> appetizers = new ArrayList<FoodDrink>();
    private static ArrayList<FoodDrink> maincourses = new ArrayList<FoodDrink>();
    private static ArrayList<FoodDrink> desserts = new ArrayList<FoodDrink>();
    private static ArrayList<FoodDrink> beverages = new ArrayList<FoodDrink>();
    private static ArrayList<FoodDrink> order1 = new ArrayList<FoodDrink>();
    ...
    public void orderMenu(int menuQuantity) {
        ...
        int orderID = Integer.parseInt(menuID.substring(1, menuID.length())); // misahin int dari string menuID
        // System.out.print("\nID " + orderID);
            ...
            if (appetizers.get(orderID - 1).getQuantity() > 0) {
                ...
                for (int i = 0; i < order1.size(); i++) {
                    if (appetizers.get(orderID - 1).getName() == order1.get(i).getName()) {
                        order1.get(i).setQuantity(menuQuantity);
                    }
                }
            } else {
